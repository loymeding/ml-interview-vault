...
$$\Large \text{logit}(P) = w^T x + b + \ln\left(\frac{w_1}{w_0}\right)$$
...
Модифицированная cross-entropy, которая уменьшает вклад "легких"(легко классифицируемых) объектов и повышает вклад "сложных".
