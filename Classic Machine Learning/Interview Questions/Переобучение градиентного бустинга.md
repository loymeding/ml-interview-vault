...
text: Объясните, как взаимосвязаны `max_depth`, `learning_rate` и `n_estimators` с точки зрения bias-variance tradeoff. Что происходит с bias и variance при увеличении каждого из этих параметров?
follow_up:
