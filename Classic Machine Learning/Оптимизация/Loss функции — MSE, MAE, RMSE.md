...
> [!cite] Подробный разбор
> Подробный числовой пример того, как один выброс может на 99% определять значение MSE, читайте в карточке: **[[Почему MSE и RMSE нестабильны к выбросам]]**.
